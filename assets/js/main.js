...
let app = new Vue({
  ...
  methods: {
    ...
    showFilmsByInput(userInput) {
      axios
        .get(
          "https://api.themoviedb.org/3/search/movie?api_key=ecab8acb7eb8a4ea7947676af9821638&query=" +
            userInput
        )
        .then((response) => {
    ...
    showTvSeriesByInput(userInput) {
      axios
        .get(
          "https://api.themoviedb.org/3/search/tv?api_key=ecab8acb7eb8a4ea7947676af9821638&query=" +
            userInput
        )
        .then((response) => {
